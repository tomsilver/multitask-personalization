...
```
python experiments/run_single_experiment.py -m env=pybullet approach=ours seed=1 env.csp_solver.max_improvement_attempts=0 env.num_eval_trials=0 env.train_env.use_gui=True llm=openai approach.motion_planning_quality=good  human_spec=smooth_human record_train_videos=true csp_solver=random_walk
```
