...
python experiments/run_single_experiment.py \
    ...
    env.book_preferences="I only like science fiction. I don't like any other kinds of fiction or nonfiction." \
    env.scene_spec.surface_dust_patch_size=4 \
    env.scene_spec.use_standard_books=true \
