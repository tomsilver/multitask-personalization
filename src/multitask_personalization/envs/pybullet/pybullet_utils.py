...
def get_user_seasoning_enjoyment_logprob(
    ...
    """Return a logprob that the user would enjoy the seasoning."""

    prompt = f"""Seasoning description: {seasoning_description}

User description: {user_preferences}

I will ask you to rate how much the user would enjoy this seasoning on a scale from 0 to 10.

IMPORTANT: if you have already seen this seasoning before, please answer based on the user's previous enjoyment of the seasoning.

How much would the user enjoy the seasoning on a scale from 0 to {num_bins-1}, where 0 means hate and {num_bins-1} means love?
